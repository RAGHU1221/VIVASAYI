...
class Router
{
    public function dispatch(): Response
    {
        ...
        $dispatcher = simpleDispatcher(function (RouteCollector $r) {
            ...
            $r->addRoute('POST', '/auth/request-otp', [self::class, 'requestOtp']);
            $r->addRoute('POST', '/auth/verify-otp', [self::class, 'verifyOtp']);
    ...
    public static function requestOtp(Request $request, array $vars): Response
    {
        $controller = new LoginController();
        return $controller->requestOtp($request);
    }

    public static function verifyOtp(Request $request, array $vars): Response
    {
        $controller = new LoginController();
